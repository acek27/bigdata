                            ...
                            <div class="col-12 table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <tr>
                                        ...
                                        @else
                                        {{$pdrb->md_besaranperbankans->besaran}} - {{$pdrb->lamakredit}} {{'bulan'}}
                                        @endif
                                        </td>
                                    </tr>
                                    <tr>
                            ...
                            <div class="col-12 table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 65%; vertical-align: middle">Apakah anda memiliki usaha dibidang Perdagangan?</td>
                        ...
                        <div class="row">
                            <div class="col-12 table-responsive">
                                <table class="table table-striped">
                                    <thead>
                                    <tr>
                                        <th style="width: 15%;text-align: center; vertical-align: middle">Jenis Usaha Perdagangan
                                        </th>
                                        <th style="width: 15%;text-align: center; vertical-align: middle">Produk Unggulan
                                        </th>
                                        <th style="width: 10%;text-align: center; vertical-align: middle">Jumlah Kulak / Bulan
                                        </th>
                                        <th style="width: 10%;text-align: center; vertical-align: middle">Harga Kulak Produk
                                        </th>
                                        <th style="width: 10%;text-align: center; vertical-align: middle">Harga Jual Produk
                                        </th>
                                        <th style="width: 15%;text-align: center; vertical-align: middle">Tempat Kulak Barang
                                        </th>
                                        <th style="width: 10%;text-align: center; vertical-align: middle">Nama Toko / Suplier
                                        </th>
                                        <th style="width: 15%;text-align: center; vertical-align: middle">Konsumen Terbanyak
                                        </th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    @foreach($perdagangan as $dagang)
                                        <tr>
                                            ...
                                            <td style="text-align:center;"> @if($kpdagang->konsumendalamkecamatan == 'Ya')
                                                    Dalam Kecamatan <br>
                                                    @if($kpdagang->konsumendalamkabupaten == 'Ya') Dalam Kabupaten <br>
                                                    @if($kpdagang->konsumenluarkabupaten == 'Ya') Luar Kabupaten <br>
                                                    @if($kpdagang->konsumenluarprovinsi == 'Ya') Luar Provinsi <br>
                                                    @endif
                                                    @endif
                                                    @endif
                                                @endif
                            ...
                            <div class="col-12 table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 65%; vertical-align: middle">Apakah anda memiliki usaha dibidang Pertanian?</td>
                                        <td style="width: 38%; vertical-align: middle">
                        ...
                        <div class="row">
                            <div class="col-12 table-responsive">
                                <table class="table table-striped">
                                    <thead>
                                    <tr>
                                        <th style="width: 15%;text-align: center; vertical-align: middle">Jenis Tanaman
                                        </th>
                                        <th style="width: 10%;text-align: center; vertical-align: middle">Luas Tanam
                                        </th>
                                        <th style="width: 10%;text-align: center; vertical-align: middle">Masa Tanam Pertama
                                        </th>
                                        <th style="width: 10%;text-align: center; vertical-align: middle">Masa Tanam Selanjutnya
                                        </th>
                                        <th style="width: 10%;text-align: center; vertical-align: middle">Kebutuhan Bibit
                                        </th>
                                        <th style="width: 10%;text-align: center; vertical-align: middle">Harga Bibit
                                        </th>
                                        <th style="width: 10%;text-align: center; vertical-align: middle">Kapasitas Panen / Periode
                                        </th>
                                        <th style="width: 10%;text-align: center; vertical-align: middle">Panen / tahun
                                        </th>
                                        <th style="width: 15%;text-align: center; vertical-align: middle">Operasional / Periode Tanam
                                        </th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    @foreach($garapanpertanian as $garaptani)
                                        <tr>
                                            ...
                                            <td style="text-align:center;">{{$garaptani->luastanam}}/{{$garaptani->md_satuanluass->satuan}}</td>
                                            ...
                                            <td style="text-align:center;">@if($garaptani->bulantanamselanjutnya == 1) Januari
                                            ...
                                            <td style="text-align:center;">{{$garaptani->hargabibit}} / {{$garaptani->md_satuanbibits->satuan}}</td>
                            ...
                            <div class="col-12 table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 65%; vertical-align: middle">Bagaimana cara anda mengelola usaha pertanian anda?
                                        </td>
                                        <td style="width: 38%; vertical-align: middle">{{$pertanian->statuspengelolaan}}</td>
                                    </tr>
                                    <tr>
                                        <td style="width: 2%; vertical-align: middle">13</td>
                                        <td style="width: 65%; vertical-align: middle">Bagaimana cara anda memeperoleh bibit?
                                        </td>
                                        <td style="width: 38%; vertical-align: middle">{{$pertanian->statuspembibitan}}</td>
                                    </tr>
                                    <tr>
                                        <td style="width: 2%; vertical-align: middle">14</td>
                                        <td style="width: 65%; vertical-align: middle">Jika membeli, Sebutkan Nama Toko, Desa / Kelurahan!
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 65%; vertical-align: middle">Berapa kebutuhan Pupuk Organik untuk usaha pertanian anda? sebutkan jenisnya!
                                        </td>
                                        <td style="width: 38%; vertical-align: middle">{{$pertanian->kebutuhanpupukorganik}} Kg - Jenis: {{$pertanian->jenispupukorganik}}</td>
                                    </tr>
                                    <tr>
                                        <td style="width: 2%; vertical-align: middle">16</td>
                                        <td style="width: 65%; vertical-align: middle">Berapa kebutuhan Pupuk Anorganik untuk usaha pertanian anda? sebutkan jenisnya!
                                        </td>
                                        <td style="width: 38%; vertical-align: middle">{{$pertanian->kebutuhanpupukanorganik}} Kg - Jenis: {{$pertanian->jenispupukanorganik}} </td>
                                    </tr>
                                    <tr>
                                        <td style="width: 2%; vertical-align: middle">17</td>
                                        <td style="width: 65%; vertical-align: middle">Bagaimana cara anda memperoleh pupuk?
                                        </td>
                                        <td style="width: 38%; vertical-align: middle">{{$pertanian->sumberpupuk}}</td>
                                    </tr>
                                    <tr>
                                        <td style="width: 2%; vertical-align: middle">18</td>
                                        <td style="width: 65%; vertical-align: middle">Jika membuat sendiri, sebutkan apa saja yang dibuat?
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 65%; vertical-align: middle">Jika membeli, sebutkan nama toko dan Desa/Kelurahan?
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 65%; vertical-align: middle">Sebutkan sumber irigasi dari usaha pertanian / perkebunan anda?
                                        </td>
                                        <td style="width: 38%; vertical-align: middle">{{$pertanian->sumberirigasi}}</td>
                                    </tr>
                                    <tr>
                                        <td style="width: 2%; vertical-align: middle">21</td>
                                        <td style="width: 65%; vertical-align: middle">Bagaimana model penjualan hasil panen anda?
                                        </td>
                                        <td style="width: 38%; vertical-align: middle">{{$pertanian->modelpenjualan}}</td>
                                    </tr>
                                    <tr>
                                        <td style="width: 2%; vertical-align: middle">22</td>
                                        <td style="width: 65%; vertical-align: middle">Jika anda mengijonkan (tebasan), berapa nilai ijon per luasan?
                                        </td>
                                        <td style="width: 38%; vertical-align: middle">@if($pertanian->hargaijon === null) -
                                        @else {{$pertanian->hargaijon}} / {{$pertanian->luasanijon}} {{$pertanian->satuanijon}}
                                        @endif
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width: 2%; vertical-align: middle">23</td>
                                        <td style="width: 65%; vertical-align: middle">Kepada siapa anda menjual hasil produksi pertanian / perkebunan anda?
                                        </td>
                                        <td style="width: 38%; vertical-align: middle">{{$pertanian->pemasaranhasil}}</td>
                                    </tr>
                                    <tr>
                                        <td style="width: 2%; vertical-align: middle">24</td>
                                        <td style="width: 65%; vertical-align: middle">Bagaimana anda mengolah limbah produksi pertanian / perkebunan anda?
                                        </td>
                                        <td style="width: 38%; vertical-align: middle">{{$pertanian->pengolahanlimbah}}</td>
                                    </tr>
                                    <tr>
                                        <td style="width: 2%; vertical-align: middle">25</td>
                                        <td style="width: 65%; vertical-align: middle">Jika diolah, sebutkan untuk apa?
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 65%; vertical-align: middle">Jika dijual, sebutkan berapa kapasitas limbah per bulan? <br>
                                        Harga jual limbah tanpa diolah?<br>
                                        Harga jual hasil olahan limbah?
                                        </td>
                                        <td style="width: 38%; vertical-align: middle">@if($pertanian->kapasitaslimbahperpanen === null) - <br> - <br> -
                                        @else
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 65%; vertical-align: middle">Sebutkan jenis sarana prasarana produksi pertanian (saprodi) yang anda miliki!
                                        </td>
                                        <td style="width: 38%; vertical-align: middle">
                                        @php($no=1)
                            ...
                            <div class="col-12 table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 65%; vertical-align: middle">Apakah anda memiliki usaha dibidang Peternakan?</td>
                                        <td style="width: 38%; vertical-align: middle">
                        ...
                        <div class="row">
                            <div class="col-12 table-responsive">
                                <table class="table table-striped">
                                    <thead>
                                    <tr>
                                        <th style="width: 15%;text-align: center; vertical-align: middle">Jenis Ternak
                                        </th>
                                        <th style="width: 15%;text-align: center; vertical-align: middle">Status kepemilikan
                                        </th>
                                        <th style="width: 10%;text-align: center; vertical-align: middle">Jumlah ternak yang dikelola
                                        </th>
                                        <th style="width: 10%;text-align: center; vertical-align: middle">Harga bibit ternak / ekor
                                        </th>
                                        <th style="width: 10%;text-align: center; vertical-align: middle">Harga jual ternak / ekor
                                        </th>
                                        <th style="width: 10%;text-align: center; vertical-align: middle">Harga jual hasil peternakan
                                        </th>
                                        <th style="width: 10%;text-align: center; vertical-align: middle">Kapasitas produksi ternak / tahun
                                        </th>
                                        <th style="width: 10%;text-align: center; vertical-align: middle">Kapasitas produksi hasil peternakan
                                        </th>
                                        <th style="width: 10%;text-align: center; vertical-align: middle">Periode produksi hasil peternakan / tahun
                                        </th>
                                        <th style="width: 15%;text-align: center; vertical-align: middle">Operasional produksi / periode produksi
                                        </th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    @foreach($pengelolaanternak as $ternak)
                                        <tr>
                                            ...
                                            <td style="text-align:center;">Rp.{{$ternak->hargajualhasilpeternakan}}</td>
                                            <td style="text-align:center;">{{$ternak->kapasitasproduksipertahun}} ekor</td>
                                            ...
                                            <td style="text-align:center;">Rp.{{$ternak->operasionalperproduksi}}</td>
                                        </tr>
                                    @endforeach
                                    </tbody>
                                </table>
                            ...
                            <div class="col-12 table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 65%; vertical-align: middle">Pernahkan ternak anda terserang penyakit?
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 65%; vertical-align: middle">Kemana penjualan hasil produksi peternakan anda?
                                        </td>
                                        <td style="width: 38%; vertical-align: middle">{{$peternakan->pemasaranhasilproduksi}}</td>
                                    </tr>
                                    <tr>
                                        <td style="width: 2%; vertical-align: middle">36</td>
                                        <td style="width: 65%; vertical-align: middle">Bagaimana anda mengelola limbah hasil peternakan anda?
                                        </td>
                                        <td style="width: 38%; vertical-align: middle">{{$peternakan->pengolahanlimbah}}</td>
                                    </tr>
                                    <tr>
                                        <td style="width: 2%; vertical-align: middle">37</td>
                                        <td style="width: 65%; vertical-align: middle">Jika dijual, sebutkan berapa kapasitas limbah perbulan? <br>
                                        Berapa harga jual limbah tanpa diolah? <br>
                                        Berapa harga jual hasil olahan limbah?
                                        </td>
                                        <td style="width: 38%; vertical-align: middle">@if($peternakan->kapasitaslimbahperbulan === null) - <br> - <br> -
                                        @else {{$peternakan->kapasitaslimbahperbulan}} <br> {{$peternakan->hargasebelumolah}} <br> {{$peternakan->hargasetelaholah}}
                                        @endif
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width: 2%; vertical-align: middle">38</td>
                                        <td style="width: 65%; vertical-align: middle">Jika diolah. sebutkan untuk apa pengolahan limbah ternak anda? Kapasitas Produksi perbulan dan harga jualnya?
                                        </td>
                                        <td style="width: 38%; vertical-align: middle">
                                        @if ($pengolahanlimbahternak->isEmpty()) -
                                        @else
                                        @foreach($pengolahanlimbahternak as $limbah)
                                        {{$limbah->md_limbahternaks->limbahternak}} - {{$limbah->kapasitasperbulan}} {{$limbah->md_satuanlimbahs->satuan}}/bulan   - Rp.{{$limbah->hargajual}}/{{$limbah->md_satuanlimbahs->satuan}}<br>
                                        @endforeach
                                        @endif
                                        </td>
                                    </tr>
                                    <tr>
                                        ...
                                        <td style="width: 65%; vertical-align: middle">Jenis pakan ternak yang digunakan? kebutuhan perhari dan harganya?
                                        </td>
                                        <td style="width: 38%; vertical-align: middle">
                                        @foreach($penggunaanpakanternak as $pakan)
                                        {{$pakan->md_jenispakanternaks->jenispakanternak}} - {{$pakan->kebutuhanperhari}} {{$pakan->md_satuanpakans->satuan}} /hari - Rp.{{$pakan->hargapakan}} /{{$pakan->md_satuanpakans->satuan}} <br>
                                        @endforeach
                                        </td>
                                    </tr>
                                    </tbody>
                            ...
                            <div class="col-12 table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 65%; vertical-align: middle">Apakah anda memiliki usaha dibidang Perikanan?</td>
                                        <td style="width: 38%; vertical-align: middle">
                        ...
                        <div class="row">
                            <div class="col-12 table-responsive">
                                <table class="table table-striped">
                                    <thead>
                                    <tr>
                                        <th style="width: 10%;text-align: center; vertical-align: middle">Jenis ikan Budidaya
                                        </th>
                                        <th style="width: 10%;text-align: center; vertical-align: middle">Luasan Budidaya
                                        </th>
                                        <th style="width: 10%;text-align: center; vertical-align: middle">Harga bibit ikan
                                        </th>
                                        <th style="width: 10%;text-align: center; vertical-align: middle">Harga jual hasil produksi
                                        </th>
                                        <th style="width: 10%;text-align: center; vertical-align: middle">Tanggal tebar benih
                                        </th>
                                        <th style="width: 10%;text-align: center; vertical-align: middle">Tanggal perkiraan panen
                                        </th>
                                        <th style="width: 10%;text-align: center; vertical-align: middle">Kapasitas produksi / tahun
                                        </th>
                                        <th style="width: 10%;text-align: center; vertical-align: middle">Periode produksi / tahun
                                        </th>
                                        <th style="width: 10%;text-align: center; vertical-align: middle">Operasional produksi / periode produksi
                                        </th>
                                        <th style="width: 10%;text-align: center; vertical-align: middle">Jenis pakan
                                        </th>
                                        <th style="width: 10%;text-align: center; vertical-align: middle">Kebutuhan pakan / hari
                                        </th>
                                        <th style="width: 10%;text-align: center; vertical-align: middle">Harga pakan
                                        </th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    @foreach($budidayaikan as $ikan)
                                        <tr>
                                            ...
                                            <td style="text-align:center;">{{$ikan->hargabibit}} /{{$ikan->satuanbibits->satuan}}</td>
                                            <td style="text-align:center;">Rp.{{$ikan->hargajual}} /{{$ikan->satuanjuals->satuan}}</td>
                                            ...
                                            <td style="text-align:center;">{{$ikan->kebutuhanpakanperhari}} {{$ikan->satuanpakans->satuan}} /hari</td>
                            ...
                            <div class="col-12 table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 65%; vertical-align: middle">Bagaimana cara anda memperoleh pakan?
                                        </td>
                                        <td style="width: 38%; vertical-align: middle">{{$perikanan->perolehanpakan}}</td>
                                    </tr>
                                    <tr>
                                        <td style="width: 2%; vertical-align: middle">42</td>
                                        <td style="width: 65%; vertical-align: middle">Jika membeli, sebutkan nama toko dan Dsa/Kelurahan!
                                        </td>
                                        <td style="width: 38%; vertical-align: middle">
                                        @if($perikanan->idsuplier === null) -
                                        @else  {{$perikanan->md_supliers->suplier}} - {{$perikanan->namasuplier}}
                                        @endif</td>
                                    </tr>
                                    <tr>
                                        <td style="width: 2%; vertical-align: middle">43</td>
                                        <td style="width: 65%; vertical-align: middle">Apakah ada pengelolaan lanjutan dari budidaya ikan anda?
                                        </td>
                                        <td style="width: 38%; vertical-align: middle">{{$perikanan->olahanlanjutan}}</td>
                                    </tr>
                                    <tr>
                                        <td style="width: 2%; vertical-align: middle">44</td>
                                        <td style="width: 65%; vertical-align: middle">Jika diolah, sebutkan untuk apa? Berapa kapasitas produksi perbulan dan harga jualnya!
                                        </td>
                                        <td style="width: 38%; vertical-align: middle">@if($perikanan->namaolahan === null) -
                                        @else {{$perikanan->namaolahan}} - {{$perikanan->produksiperbulan}} {{$perikanan->md_satuanproduksis->satuan}} - Rp.{{$perikanan->hargajual}} /{{$perikanan->md_satuanjuals->satuan}}
                                        @endif</td>
                                    </tr>
                                    <tr>
                                        <td style="width: 2%; vertical-align: middle">45</td>
                                        <td style="width: 65%; vertical-align: middle">Kemana pemasaran hasil produksi / olahan?
                                        </td>
                                        <td style="width: 38%; vertical-align: middle">
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 65%; vertical-align: middle">Bila anda bergerak dibidang perikanan tangkap, jenis ikan apa yang dominan anda tangkap dan berapa perkiraan kapasitas penangkapan dalam satu hari?
                                        </td>
                                        <td style="width: 38%; vertical-align: middle">
                                        ...
                                        {{$it}} {{'. '}} {{$ikantangkap->md_jenisikantangkaps->jenisikan}} - {{$ikantangkap->kapasitasperhari}} Kg /hari
                                        @php($it++)
                                        @endforeach
                                        @endif
                                        </td>
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 65%; vertical-align: middle">Kemana pemasaran utama ikan hasil tangkapan anda?
                                        </td>
                                        <td style="width: 38%; vertical-align: middle">
                                        @if($perikanantangkap->isEmpty()) -
                                        @else 
                                        ...
                                        @if($ikantangkap->pemasarandalamkabupaten == 'Ya') Dalam Kabupaten
                                        @endif
                                        @if($ikantangkap->pemasaranluarkabupaten == 'Ya'), Luar Kabupaten
                                        @endif
                            ...
                            <div class="col-12 table-responsive">
                                <table class="table table-striped">
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 65%; vertical-align: middle">Apakah anda memiliki usaha dibidang jasa?</td>
                                        <td style="width: 38%; vertical-align: middle">
                        ...
                        <div class="row">
                            <div class="col-12 table-responsive">
                                <table class="table table-striped">
                                    <thead>
                                    <tr>
                                        <th style="width: 10%;text-align: center; vertical-align: middle">Jenis Usaha Jasa
                                        </th>
                                        <th style="width: 10%;text-align: center; vertical-align: middle">Rata-rata Konsumen / minggu
                                        </th>
                                        <th style="width: 10%;text-align: center; vertical-align: middle">Rata-rata Penghasilan / bulan
                                        </th>
                                        <th style="width: 10%;text-align: center; vertical-align: middle">Konsumen Utama
                                        </th>
                                    </tr>
                                    </thead>
                                    <tbody>
