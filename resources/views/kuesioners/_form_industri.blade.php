...
<div class="form-group">
    ...
    <div class="col-md-1">
        <input onclick="checkindustri(this.value)" class="form-group" name="bidangindustri" id="bidangindustri" value="1" class="form-check-input" type="radio">
        <label class="form-check-label">Ya</label>
    </div>
    <div class="col-md-1">
        <input onclick="checkindustri(this.value)" class="form-group" name="bidangindustri" id="bidangindustri" value="0" class="form-check-input" type="radio">
...
<div id="divjenisindustri" class="form-group">
    <label for="inputDescription">10. Pilihlah jenis usaha pembuatan/industri anda dan isikan keterangannya : (bisa memilih dan mengisi lebih dari satu)</label>
    <div class="col-12">
      <div class="card">
        <!-- /.card-header -->
        <div class="card-body table-responsive p-0" style="height: 500px;">
            <table class="table table-head-fixed text-nowrap">
                ...
                @foreach($jenisindustri as $industri)
                    <tr>
                        <td>
                            <input onclick="checkjenisindustri()" name="idjenisindustri{{$i}}" id="idjenisindustri{{$i}}" value="{{$industri->id}}"
                                   class="form-group-input" type="checkbox">
                            <label for="idjenisindustri{{$i}}">{{$industri->id}}{{'. '}}{{$industri->jenisindustri}}</label>
                        </td>
                        <td id="kolom2{{$i}}" style="display: none" >{{ Form::text('namaproduk'.$i,null,['class'=>'form-control','id' => 'namaproduk'.$i]) }}
                        </td>
                        <td id="kolom3{{$i}}" style="display: none">
                        ...
                        <td id="kolom4{{$i}}" style="display: none">{{ Form::select('idbahanbaku'.$i,$bahanbaku,null,[
                            'class'=>'form-control select2','placeholder' => 'Pilih',
                            'id' => 'idbahanbaku'.$i
                            ]) }}
                        </td>
                        <td id="kolom5{{$i}}" style="display: none">
                            {{ Form::text('kebutuhanperbulan'.$i,null,[
                                'class'=>'form-control',
                                'id' => 'kebutuhanperbulan'.$i
                            ]) }}
                        </td>
                        <td id="kolom6{{$i}}" style="display: none">
                            {{ Form::select('satuanbahanbaku'.$i,$satuan,null,[
                            'class'=>'form-control select2','placeholder' => 'Pilih',
                            'id' => 'satuanbahanbaku'.$i
                            ]) }}
                        </td>
                        <td id="kolom7{{$i}}" style="display: none">
                            <div class="input-group">
                        ...
                        <td id="kolom8{{$i}}" style="display: none">
                            {{ Form::select('satuankulak'.$i,$satuan,null,[
                           'class'=>'form-control select2','placeholder' => 'Pilih',
                           'id' => 'satuankulak'.$i
                           ]) }}
                        </td>
                        <td id="kolom9{{$i}}" style="display: none">
                            {{ Form::select('idsuplier'.$i, $suplier,null,[
                                  'class'=>'form-control select2','placeholder' => 'Pilih',
                                  'id' => 'idsuplier'.$i
                                  ]) }}
                        </td>
                        <td id="kolom10{{$i}}" style="display: none">
                        {{ Form::text('namasuplier'.$i,null,[
                                    'class'=>'form-control',
                                    'id' => 'namasuplier'.$i
                                ]) }}
                        </td>
                        <td id="kolom11{{$i}}" style="display: none">
                            <div class="input-group">
                                <div class="input-group-prepend">
                                    <span class="input-group-text">Rp.</span>
                                </div>
                        ...
                        <td id="kolom12{{$i}}" style="display: none">
                        ...
                        <td id="kolom13{{$i}}" style="display: none">
                            <div class="input-group">
                                <div class="input-group-prepend">
                                    <span class="input-group-text">Rp.</span>
                                </div>
                        ...
                        <td id="kolom14{{$i}}" style="display: none">
                                    <input name="pemasarandalamkabupaten{{$i}}" id="pemasarandalamkabupaten{{$i}}" value="1"
                                        class="form-group-input" type="checkbox">
                                    <label for="pemasarandalamkabupaten{{$i}}" class="form-check-label">Dalam Kabupaten</label>
                ...
                <tr>
                    <td>
                        <div class="input-group">
                            <input onclick="checkjenisindustri()" name="idjenisindustri{{$i}}" id="idjenisindustri{{$i}}" value="99"
                                   class="form-group-input" type="checkbox">
                            {{ Form::text('jenisindustri'.$i,null,['disabled' =>'disabled','class'=>'form-control','id' => 'jenisindustri'.$i,'placeholder'=>'Ketik Nama Usaha']) }}
                        </div>
                    </td>
                    <td id="kolom2{{$i}}" style="display: none">
